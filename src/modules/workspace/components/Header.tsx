...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-20 bg-card/70 backdrop-blur-xl border-b border-border flex items-center justify-between px-8 sticky top-0 z-40 transition-all duration-200">
